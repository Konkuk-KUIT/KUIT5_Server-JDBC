 ...
 * Generated at: 2025-05-05 05:19:16 UTC
...
public final class show_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  static {
    ...
    _jspx_dependants.put("/include/header.jspf", Long.valueOf(1745740123639L));
    _jspx_dependants.put("/include/navigation.jspf", Long.valueOf(1745740123639L));
    _jspx_dependants.put("file:/C:/Users/uchan/.gradle/caches/modules-2/files-2.1/javax.servlet/jstl/1.2/74aca283cd4f4b4f3e425f5820cda58f44409547/jstl-1.2.jar", Long.valueOf(1743855980208L));
    _jspx_dependants.put("jar:file:/C:/Users/uchan/.gradle/caches/modules-2/files-2.1/javax.servlet/jstl/1.2/74aca283cd4f4b4f3e425f5820cda58f44409547/jstl-1.2.jar!/META-INF/c.tld", Long.valueOf(1153352682000L));
  }
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("<script>\r\n");
      out.write("    //자바 스크립트\r\n");
      out.write("    $(\".answerWrite input[type=submit]\").click(addAnswer);\r\n");
      out.write("\r\n");
      out.write("    function addAnswer(e) {\r\n");
      out.write("        e.preventDefault();\r\n");
      out.write("        var queryString = $(\".submit-write\").serialize();\r\n");
      out.write("\r\n");
      out.write("        $.ajax({\r\n");
      out.write("            type : 'post',\r\n");
      out.write("            url : '/api/qna/addAnswer',\r\n");
      ...
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    //요청이 성공했을 때 아래 함수를 실행 시킴. 즉, 동적으로 화면 생성\r\n");
      out.write("    function onSuccess(json, status){\r\n");
      out.write("        var answerTemplate = $(\"#answerTemplate\").html();\r\n");
      out.write("        var template = answerTemplate.format(json.answer.writer, new Date(json.answer.createdDate), json.answer.contents, json.answer.answerId, json.answer.answerId);\r\n");
      out.write("        $(\".qna-comment-kuit-articles\").prepend(template);\r\n");
      out.write("        var countOfAnswer = document.getElementsByTagName(\"strong\").item(0);\r\n");
      out.write("        let number = parseInt(countOfAnswer.innerText,10);\r\n");
      out.write("        number += 1;\r\n");
      out.write("        countOfAnswer.textContent = number.toString();\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    function onError(xhr, status) {\r\n");
      out.write("        alert(\"error\");\r\n");
      out.write("    }\r\n");
      out.write("\r\n");
      out.write("    String.prototype.format = function() {\r\n");
      out.write("        var args = arguments;\r\n");
      out.write("        return this.replace(/{(\\d+)}/g, function(match, number) {\r\n");
      out.write("            return typeof args[number] != 'undefined'\r\n");
      out.write("                ? args[number]\r\n");
      out.write("                : match\r\n");
      out.write("                ;\r\n");
      out.write("        });\r\n");
      out.write("    };\r\n");
